      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        {!pathname.startsWith("/apply") && (
          <div className="hidden lg:flex items-center gap-4">
            <Button asChild className="bg-transparent text-blue-500 hover:bg-blue-50 font-semibold flex items-center gap-2">
        ...
        <div className="flex flex-col h-full">
          ...
          {!pathname.startsWith("/apply") && (
            <div className="p-4 space-y-2">
              <Button asChild className="w-full bg-transparent text-blue-600 hover:bg-blue-50 font-semibold flex items-center justify-center gap-2" onClick={closeMenu}>
